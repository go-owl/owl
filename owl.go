// Package owl is a small, idiomatic and composable router for building HTTP services.
// Forked from go-chi/chi for private company use.
//
// owl supports the four most recent major versions of Go.
//
// Example:
//
//	package main
...
// owl.URLParam(). All patterns must begin with a slash.
//
